...
pub const RENDEZVOUS_SERVERS: &[&str] = &["wsrust.waitsun.cn"];
pub const PUBLIC_RS_PUB_KEY: &str = "HW2S66UtS+QZzrszTCL6Y+US7EtVua9IKRtVIfsxJEI=";
...
pub const RENDEZVOUS_PORT: i32 = 58336;
pub const RELAY_PORT: i32 = 58337;
